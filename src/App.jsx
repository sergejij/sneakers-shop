  ...
  return (
    <div className="App p-50">
      ...
      <div className="content">
        <header className="d-flex justify-between align-center pr-30 pl-30">
          <div className="header-left d-flex justify-between align-center">
          ...
          <ul className="header-right d-flex justify-between align-center">
            <li className="cart-sum d-flex align-center justify-between">
        ...
        <main className="p-50">
          ...
          <div className="d-flex justify-center flex-wrap align-center">
            ...
            <div className="card d-flex flex-column justify-center align-center">
              ...
              <img width={133} height={112} src="/img/sneakers/2.png" alt="sneaker" />
            ...
            <div className="card d-flex flex-column justify-center align-center">
              <button type="button" className="heart heart-red d-flex justify-center align-center">
                <img src="/img/red-heart.png" alt="red-heart" />
              </button>
              <img width={133} height={112} src="/img/sneakers/3.png" alt="sneaker" />
              <h5>Кроссовки Puma X Aka Boku Future Rider</h5>
              <div className="d-flex align-center justify-between w100p">
                <div className="price">
                  <p className="text-uppercase">Цена:</p>
                  <p className="fw-bold">8 499 руб.</p>
                </div>
                <button type="button" className="addButton d-flex justify-center align-center">
                  <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10.6653 5.13122H7.20214V1.66821C7.20214 0.332846 5.13114 0.332846 5.13114 1.66821V5.13122H1.668C0.332935 5.13122 0.332935 7.20215 1.668 7.20215H5.13114V10.6652C5.13114 12.0005 7.20214 12.0005 7.20214 10.6652V7.20215H10.6653C12.0005 7.20215 12.0005 5.13122 10.6653 5.13122Z" fill="#D3D3D3" />
            ...
            <div className="card d-flex flex-column justify-center align-center">
              ...
              <img width={133} height={112} src="/img/sneakers/4.png" alt="sneaker-photo" />
              <h5>Кроссовки Puma X Aka Boku Future Rider</h5>
              <div className="d-flex align-center justify-between w100p">
                <div className="price">
                  <p className="text-uppercase">Цена:</p>
                  <p className="fw-bold">8 999 руб.</p>
                </div>
                <button type="button" className="addButton d-flex justify-center align-center">
                  <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10.6653 5.13122H7.20214V1.66821C7.20214 0.332846 5.13114 0.332846 5.13114 1.66821V5.13122H1.668C0.332935 5.13122 0.332935 7.20215 1.668 7.20215H5.13114V10.6652C5.13114 12.0005 7.20214 12.0005 7.20214 10.6652V7.20215H10.6653C12.0005 7.20215 12.0005 5.13122 10.6653 5.13122Z" fill="#D3D3D3" />
